...
running command...
$ m30pm (--version)
m30pm/0.1.0-alpha.2 linux-x64 node-v23.8.0
$ m30pm --help [COMMAND]
USAGE
  $ m30pm COMMAND
...
...
_See code: [src/commands/project/create.ts](https://github.com/Mach30/m30pm/blob/v0.1.0-alpha.2/src/commands/project/create.ts)_
<!-- commandsstop -->
